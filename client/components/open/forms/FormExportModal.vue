          ...
          <VTransition name="fade">
            ...
            >
              <div class="w-16 h-16 mx-auto relative">
                ...
                ></div>
                <div
                  class="relative w-full h-full bg-blue-200 rounded-full flex items-center justify-center"
                >
                  <UIcon
              ...
              <div class="space-y-2">
                ...
                <p class="text-sm text-neutral-500">في انتظار بدء المعالجة…</p>
              </div>
            </div>
            ...
            >
              <div class="w-20 h-20 mx-auto relative">
                ...
                >
                  ...
                  <circle
                    ...
                    :stroke-dashoffset="
                      175.93 - (175.93 * smoothProgress) / 100
                    "
              ...
              <div class="space-y-2">
                <p class="text-neutral-700 font-semibold">معالجة الإجابات</p>
            ...
            >
              ...
              <div class="space-y-3">
                <p class="text-red-600 font-semibold text-lg">فشل التصدير</p>
                <p class="text-sm text-neutral-600">{{ exportError }}</p>
                <UButton color="red" @click="closeModal">إغلاق</UButton>
              </div>
            </div>
            ...
            <div v-else key="loading" class="text-center space-y-4">
              <div class="w-16 h-16 mx-auto relative">
                <div
                  class="absolute inset-0 bg-neutral-200 rounded-full animate-pulse"
                ></div>
                <div
                  class="relative w-full h-full bg-neutral-100 rounded-full flex items-center justify-center"
                >
                  <UIcon
                    name="i-heroicons-arrow-down-tray"
                    class="w-8 h-8 text-neutral-500 animate-bounce"
                  />
                </div>
              </div>
              <div class="space-y-2">
                <p class="text-neutral-700 font-medium">بدء التصدير</p>
                <p class="text-sm text-neutral-500">يرجى الانتظار...</p>
              </div>
            </div>
          </VTransition>
        </div>
...
const checkExportStatus = () => {
  ...
  formsApi.submissions
    .exportStatus(props.form.id, exportJobId.value)
    .then((response) => {
