<template>
  <UModal
    ...
    title="🎉 إجابتك الأولى!"
  >
    <template #body style="direction: rtl">
      <div class="text-sm text-neutral-500 mb-6">
        مبروك! أصبح نموذجك الآن نشطًا وجاهزًا للاستخدام. شاركه مع الآخرين أو
        تحقق من الإجابات أدناه.
      </div>
      ...
      <div class="space-y-3 mb-6">
        <div class="flex gap-3 items-center">
          ...
          <ShareFormUrl class="flex-grow" :form="form" />
        </div>
      ...
      <!-- <div class="border-t border-neutral-200 dark:border-neutral-700 pt-5">
        <div class="flex items-center justify-between mb-3">
          <p
            class="text-neutral-700 dark:text-neutral-200 font-semibold text-sm"
          >
        ...
        <p class="text-xs text-neutral-500 mb-4">
          Get notified instantly when someone submits your form, or sync data to
          your favorite tools.
        </p> -->
          ...
          <div class="flex items-start gap-3">
            ...
            <div class="flex-grow">
              <div class="flex items-center gap-2">
                <p
                  class="text-sm font-semibold text-neutral-800 dark:text-white"
                >
                  Email Notification
                </p>
              ...
              <p class="text-xs text-neutral-600 dark:text-neutral-400 mt-1">
                Get an email every time someone submits your form. Perfect for
                staying on top of responses.
              </p>
            </div>
            <Icon
      ...
      <!-- <p class="text-xs text-neutral-500 mb-2">Other popular integrations:</p>
        <div class="grid grid-cols-4 gap-2">
          ...
          >
            ...
            />
            <p
              class="text-xs text-neutral-600 dark:text-neutral-400 mt-1.5 text-center font-medium truncate w-full"
            >
              {{ integration.name }}
            </p>
            <pro-tag
...
const openIntegrationPage = (integration) => {
  amplitude.logEvent("form_first_submission_modal_integration_click", {
