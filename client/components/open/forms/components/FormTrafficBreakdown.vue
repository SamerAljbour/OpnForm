<template>
  <div class="w-full">
    <h3 class="font-medium text-lg mb-4">توزيع الزيارات</h3>

    <div
      v-if="!form.is_pro"
      class="border border-neutral-300 rounded-lg shadow-xs p-4 relative overflow-hidden"
    >
          ...
          <UButton
            ...
            @click.prevent="
              openSubscriptionModal({
                modal_title: 'Upgrade to unlock detailed Analytics',
              })
            "
            label="Subscribe"
          />
    ...
    <VTransition v-else name="fade">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div
            v-if="Object.keys(metaStats[chart.id] || {}).length === 0"
            ...
            <div class="flex flex-wrap gap-3 items-center justify-center mt-2">
              ...
              >
                ...
                >
                  ...
                  ></div>
                  <span class="text-xs"
                    >{{ item.displayName }} ({{ item.count }})</span
                  >
                </div>
                ...
                <UPopover v-else arrow>
                  ...
                  <template #content>
                    <div
                      class="w-72 p-3 max-h-40 overflow-y-auto bg-white shadow-lg rounded-md"
                    >
                      <div class="space-y-2">
                        <div
