<template>
  <div
    class="p-4 flex gap-2 group items-center relative border rounded-lg shadow-xs hover:bg-neutral-100 transition-all cursor-pointer"
  >
    <!-- Title -->
    ...
    <div class="flex items-center gap-4 relative text-sm text-neutral-500">
      ...
      <!-- Last Updated -->
      <span
        class="hidden lg:inline text-xs whitespace-nowrap"
        title="Last updated"
        >Updated {{ form.last_edited_human }}</span
      >
      ...
      <!-- Submissions -->
      <UTooltip
        :text="`${formatNumberWithCommas(form.submissions_count)} submissions`"
      >
