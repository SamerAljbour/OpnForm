<template>
  <div class="flex flex-col sm:flex-row h-screen bg-white">
    ...
    <!-- Main content area -->
    <main class="flex-1 sm:pr-58 overflow-hidden">
      <div class="flex flex-col h-full">
        ...
        <div v-if="isLoading || !isFormFinished" class="flex-1 bg-white">
          ...
          <div
            :class="[
              'flex-1 bg-white p-4',
              { 'overflow-y-auto': !isSubmissionsPage },
            ]"
          >
        ...
        <template v-else-if="form">
          ...
          <div class="bg-white p-4 pb-0">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex gap-2">
                  ...
                  >
                    <span class="hidden sm:inline">
                      افتح
                      <span class="hidden md:inline">النموذج</span>
                    </span>
                  </UButton>
                  <TrackClick
                    v-else
                  ...
                  >
                    ...
                    >
                      تعديل <span class="hidden md:inline">النموذج</span>
                    </UButton>
                  </TrackClick>
                  <extra-menu
                    v-if="!workspace?.is_readonly"
              ...
              <div
                class="flex flex-wrap items-center gap-2 text-neutral-500 text-xs mt-2 sm:mt-0"
              >
                <UTooltip
                  :text="`${formatNumberWithCommas(form.views_count)} عرض/مشاهدات`"
                >
                ...
                <UTooltip
                  :text="`${formatNumberWithCommas(form.submissions_count)} الإجابات / التقديمات`"
                >
                  <div class="flex items-center gap-1">
                ...
                <span class="whitespace-nowrap"
                  >Edited {{ form.last_edited_human }}</span
                >
              </div>
        ...
        <!-- Not Found State -->
        <div v-else class="flex items-center justify-center h-screen bg-white">
          <div class="flex flex-col gap-4 items-center justify-center">
            <h2 class="text-lg font-semibold text-neutral-900">
              النموذج غير موجود
            </h2>
            <p class="text-neutral-500">
              النموذج الذي تبحث عنه غير موجود أو تم حذفه.
            </p>
            <div class="">
              <UButton
                variant="soft"
...
const {
  ...
  isFetched: isFormFinished,
} = formDetail(slug, { usePrivate: true });
