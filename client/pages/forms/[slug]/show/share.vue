  ...
  <div class="p-4 space-y-8">
    <div class="w-full max-w-4xl mx-auto flex flex-col gap-4">
      ...
      <UAlert
        ...
        variant="subtle"
        title="النموذج مسودة"
        description="يمكنك فقط زيارة رابط النموذج أثناء تسجيل الدخول. الزوار لن يتمكنوا من الوصول إلى هذا النموذج."
      />
      ...
      <UAlert
        ...
        variant="subtle"
        title="النموذج مغلق"
        description="يمكن للناس الوصول إلى النموذج، لكنه لن يقبل أي إرسال جديد."
      />
      ...
      <UCard class="shadow">
        <div class="space-y-4">
          <div class="flex flex-wrap items-center gap-2">
            <h2 class="text-xl grow font-semibold">شارك نموذجك</h2>
          ...
          <p class="text-neutral-600 text-sm">
            شارك النموذج مع أي شخص عن طريق نسخ هذا الرابط. يمكنك استخدامه على
            وسائل التواصل الاجتماعي، في الرسائل، أو إرساله عبر البريد الإلكتروني
            للوصول إلى جمهورك.
          </p>
      ...
      <UCard class="shadow-sm">
        <div class="space-y-4">
          <h2 class="text-xl font-semibold">تضمين النموذج</h2>
          <p class="text-neutral-600 text-sm">
            قم بتضمين نموذجك في موقعك عن طريق نسخ كود HTML أدناه.
          </p>
