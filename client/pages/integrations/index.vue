<template>
  <div class="relative">
    <div class="mt-2 flex flex-col">
      <div v-if="loading" class="bg-white py-12 px-4 sm:px-6 lg:px-8">
        <loader class="mx-auto h-6 w-6" />
      </div>
      <div v-else class="bg-white py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div class="flex justify-between items-start">
                <div
                  class="w-10 h-10 bg-white border border-neutral-200 rounded-xl flex items-center justify-center"
                >
                  <Icon :name="integration.icon" class="w-8 h-8" dynamic />
                </div>
                <a
                  href="#"
      ...
      <div class="bg-white p-10 max-w-6xl mx-auto">
        ...
        <div
          class="grid grid-cols-1 md:grid-cols-3 gap-10 text-neutral-800 max-w-6xl mx-auto"
        >
          <div v-for="guide in setupGuides" :key="guide.title">
            ...
            <ol class="space-y-4 text-base">
              ...
              >
                <span
                  class="w-8 h-8 flex items-center justify-center rounded-full bg-blue-100 text-blue-700 font-bold"
                  >{{ index + 1 }}</span
                >
                <span v-html="sanitizeStep(step)" />
              </li>
            </ol>
          </div>
        </div>
      ...
      <div
        class="bg-[#f4f9ff] max-w-6xl mx-auto rounded-3xl m-10 p-10 flex justify-between items-center"
      >
        <div class="max-w-md">
          <h2 class="text-3xl font-bold text-neutral-900">Need help?</h2>
...
const integrationsList = computed(() => {
  ...
  return Object.values(pages.value)
...
// Sanitize each setup guide step — steps contain intentional <b> tags for formatting,
// but if this data ever comes from a CMS or API the surface is immediately exploitable
const sanitizeStep = (step) => $sanitize(step);
