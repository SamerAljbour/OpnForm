...
(function () {
  ...
  // Safe DOM construction — avoids innerHTML with user-supplied emoji value (XSS risk)
  const emojiIconSpan = document.createElement("span")
  emojiIconSpan.className = "nf-emoji-icon"
  emojiIconSpan.textContent = emoji  // textContent never executes HTML

  const emojiCloseSpan = document.createElement("span")
  emojiCloseSpan.className = "nf-emoji-icon-close"
  ...
  emojiCloseSpan.appendChild(svg)
  emojiButton.appendChild(emojiIconSpan)
  emojiButton.appendChild(emojiCloseSpan)
